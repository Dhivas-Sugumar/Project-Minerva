...
class EnrollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enroll" do
    assert_difference("Enroll.count") do
      post enrolls_url, params: { enroll: { completed: @enroll.completed, course_id: @enroll.course_id, user_id: @enroll.user_id } }
    end
  ...
  test "should update enroll" do
    patch enroll_url(@enroll), params: { enroll: { completed: @enroll.completed, course_id: @enroll.course_id, user_id: @enroll.user_id } }
